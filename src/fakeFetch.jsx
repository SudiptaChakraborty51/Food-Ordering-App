        ...
        resolve({
          ...
          data: {
            menu: [
              ...
              {
                id: 6,
                name: "Eggplant & Ricotta Rolls",
                description:
                  "vegetarian recipe and make for a rich and delicious dish that the whole family will love.",
                price: 13.99,
                image:
                  "https://www.countdown.co.nz/Content/Recipes/231568-large-EggplantandRicottaRolls-810x520.jpg",
                is_vegetarian: true,
                is_spicy: true,
                delivery_time: 25
              }
